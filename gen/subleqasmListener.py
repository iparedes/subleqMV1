...
if __name__ is not None and "." in __name__:
    from .subleqasmParser import subleqasmParser
else:
    from subleqasmParser import subleqasmParser

# This class defines a complete listener for a parse tree produced by subleqasmParser.
class subleqasmListener(ParseTreeListener):
